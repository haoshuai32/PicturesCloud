...
// 本地相册管理
//class PPhotoManager: NSObject, HPhotoManager, PHPhotoLibraryChangeObserver {
//
//    static let shared = PPhotoManager()
//
//    private let imageManager = PHCachingImageManager()
//
//    private var assets: PHFetchResult<PHAsset>
//
//    private var dataSource: [HPHAsset] = []
//
...
//        }
//
//        var list = Array<HPHAsset>.init(repeating: HPHAsset(asset: firstObject), count: assets.count)
